...
from coffee import YouTube, app
from coffee.core.userbot import assistants
from coffee.misc import SUDOERS, pymongodb
from coffee.plugins import ALL_MODULES
from coffee.utils.database import (get_global_tops,
                                       get_particulars, get_queries,
                                       get_served_chats,
                                       get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from coffee.utils.decorators.language import language, languageCB
from coffee.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,
    ...
    def get_stats():
        ...
        if what in ["Tracks", "Here"]:
            for items, count in list_arranged.items():
                ...
                if items == "telegram":
                    msg += f"🍒 [𓏺𝙎𝙊𝙐𝙍𝘾𝞝 cσffєє](https://t.me/K_OK0KK) ** التشفيل {count} الوقت**\n\n"
                else:
