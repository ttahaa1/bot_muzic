...
#       #             #  #####  #####      ####
#        #  كود الرتبه الوهميه برمجة ##|coffee        #  #         #            #     #
#          #        #  #####  #            #####    
#           #    #    #          #     ##   #     #
#              #      #####   ######   #     #
...
async def iddd(client, message):# البريميوم الوهمي كتابة ##|coffee
...
async def idjjdd(client, message):
    ...
    usr = await client.get_chat(message.from_user.id)
    name = usr.first_name
    i = ["0","10", "15","20", "25","30","35", "40","45", "50","55", "60"," 66", "70","77", "80","85", "90","99", "100","1000","9999" ]
    ik = random.choice(i)
    photo = await app.download_media(usr.photo.big_file_id)
