...
from coffee.misc import db
from coffee.utils import (Anonbin, get_channeplayCB,
                              seconds_to_min)
from coffee.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from coffee.utils.decorators.language import language, languageCB
from coffee.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/3e5039ee25df9814417c8.jpg",
        caption=_["queue_1"],
    )
